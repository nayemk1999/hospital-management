        ...
        <section>
            <div className="row">
                ...
                <div className="col-md-8 col-sm-12 col-10">
                        ...
                        <tbody>
                            {loading && patients.length > 0 ?
                                ...
                                <div className="text-center">
                                    {loading ?
                                        <h4 className="mt-1 text-danger">You haven't added any Patients yet. Please add and come to this page.</h4>
                                        :
                    ...
                    <h2 className="fw-bold mt-5 text-center" style={{ color: 'black' }}>Total Added Patients : <span className='text-danger'>{patients.length}</span></h2>
                </div>
            </div>
        </section>
    );
